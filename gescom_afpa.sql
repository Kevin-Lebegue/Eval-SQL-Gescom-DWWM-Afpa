...
--
-- Hôte : localhost:3306
-- Généré le : jeu. 24 juin 2021 à 14:13
...
-- Procédures
--
CREATE DEFINER=`my_user`@`localhost` PROCEDURE `facture` (IN `p_Num_Com` INT(10))  BEGIN
...
--
-- Déchargement des données de la table `commander_articles`
--

INSERT INTO `commander_articles` (`codart`, `qte`, `date`) VALUES
(8, 1, '2021-06-24');
...
(10, NULL, 14, 'HILLARY', 'Dorian', '6824 Placerat. Route', '12787', 'Parramatta', 'mus@Morbi.co.uk', '0102030405', '20450.00', '2002-03-10', 'M', 2, 2, 6),
...
(13, NULL, 14, 'ABRAHAM', 'François', '612-4178 Urna Chemin', '87784', 'Llanidloes', 'sodales@malesuadaInteger.com', '0102030405', '20450.00', '2012-09-08', 'M', 5, 3, 6),
...
(17, NULL, 14, 'HASZIC', 'Alec', '370-2193 Sed Rd.', '39132', 'Orangeville', 'cursus.Nunc@amet.edu', '0102030405', '20450.00', '2006-09-15', 'M', 4, 3, 6),
...
(19, NULL, 14, 'BALZAC', 'Jérémy', 'CP 630, 2906 Mollis Route', '0247', 'Colchester', 'penatibus.et@sempertellusid.net', '0102030405', '20450.00', '2009-07-29', 'M', 3, 3, 6),
(20, NULL, 14, 'YETTA', 'Ahmed', '228-2670 Luctus. Route', '85726', 'Havillers', 'non@ac.edu', '0102030405', '20450.00', '2008-03-13', 'M', 0, 2, 6),
...
(38, NULL, 14, 'SIMONE', 'George', '700-7880 Gravida Av.', '52439', 'Allentown', 'nostra@fringillaest.ca', '0102030405', '20450.00', '2000-04-07', 'M', 2, 3, 6),
...
(44, NULL, 14, 'ISAAC', 'Christine', 'Appartement 717-2181 Et Impasse', '88779', 'Roux', 'lacus@Donecnonjusto.co.uk', '0102030405', '20450.00', '2016-01-09', 'F', 1, 2, 6),
(45, NULL, 14, 'QUAMAR', 'Allistair', 'Appartement 223-3446 Mollis Rd.', '55469', 'Güssing', 'orci@ultricesiaculis.ca', '0102030405', '20450.00', '2016-10-30', 'M', 0, 3, 6),
...
(57, NULL, 14, 'MALIK', 'Keiko', 'Appartement 633-956 Quis, Rd.', '45000', 'Orléans', 'pede.ultrices.a@lacusEtiam.org', '0102030405', '20450.00', '2003-03-21', 'F', 2, 2, 6),
...
(67, NULL, 14, 'Cole', 'ALLISTAIR', '27 rue Denis Garnier', '58318', 'Sierning', 'vel@vitae.net', '0102030405', '20450.00', '2007-11-26', 'M', 3, 3, 6),
...
(78, NULL, 14, 'TIMON', 'Alyssa', 'CP 503, 6759 Ultricies Avenue', '79444', 'Rockhampton', 'Sed.et.libero@necorci.org', '0102030405', '20450.00', '2005-03-25', 'F', 3, 1, 6),
...
(103, NULL, 14, 'PALMER', 'Mia', '1044 Vivamus Ave', 'K1K 9', 'Rajanpur', 'et@lectus.edu', '0102030405', '20450.00', '2015-10-05', 'M', 1, 2, 6),
...
(8, 27, '249.99', 'barb002', NULL, 4, 5, 'Noir', 'Athos', 'Cu\'rabitur pellentesque posuere luctus. Sed et risus vel quam pharetra pretium non quis odio. Praesent varius risus vel orci ultrices tincidunt.', 0, 4, '2016-06-14 00:00:00', NULL, 'jpg'),
...
CREATE TABLE `shops` (
  `sho_id` tinyint UNSIGNED NOT NULL,
...
--
-- Doublure de structure pour la vue `v_gescom_catalogue`
-- (Voir ci-dessous la vue réelle)
--
CREATE TABLE `v_gescom_catalogue` (
`cat_id` int unsigned
,`cat_name` varchar(50)
,`pro_id` int unsigned
,`pro_name` varchar(50)
...
--
-- Structure de la vue `v_gescom_catalogue`
--
DROP TABLE IF EXISTS `v_gescom_catalogue`;

CREATE ALGORITHM=UNDEFINED DEFINER=`my_user`@`localhost` SQL SECURITY DEFINER VIEW `v_gescom_catalogue`  AS  select `products`.`pro_id` AS `pro_id`,`products`.`pro_ref` AS `pro_ref`,`products`.`pro_name` AS `pro_name`,`categories`.`cat_id` AS `cat_id`,`categories`.`cat_name` AS `cat_name` from (`products` join `categories` on((`categories`.`cat_id` = `products`.`pro_cat_id`))) ;
...
--
ALTER TABLE `commander_articles`
  MODIFY `codart` int UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;
...
--
ALTER TABLE `departments`
  MODIFY `dep_id` tinyint UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;

--
-- AUTO_INCREMENT pour la table `employees`
--
ALTER TABLE `employees`
  MODIFY `emp_id` int UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=108;
...
--
ALTER TABLE `posts`
  MODIFY `pos_id` int UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=38;
...
--
ALTER TABLE `shops`
  MODIFY `sho_id` tinyint UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
...
--
-- Contraintes pour la table `commander_articles`
--
ALTER TABLE `commander_articles`
